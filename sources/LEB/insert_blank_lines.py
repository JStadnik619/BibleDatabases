...
\v 4 through which things he has bestowed on us his precious and very great promises, so that through these you may become sharers of the divine nature \add after\add*\ef + \fr 1:4 \ft ﻿*Here “after” is supplied as a component of the participle (“escaping from”) which is understood as temporal \ef* escaping from the corruption \add that is\add* in the world because of evil desire, 
\v 5 and \add for\add* this same \add reason\add*, and \add by\add*\ef + \fr 1:5 \ft ﻿*Here “by” is supplied as a component of the participle (“applying”) which is understood as means \ef* applying all diligence, supply with your faith excellence of character, and with excellence of character, knowledge, 
...
\m 
\v 8 For \add if\add*\ef + \fr 1:8 \ft ﻿*Here “if” is supplied as a component of the participle (“are”) which is understood as conditional \ef* these \add things\add* are yours and are increasing, this does not make \add you\add* useless or unproductive in the knowledge of our Lord Jesus Christ. 
...
\v 10 Therefore, brothers, be zealous even more to make your calling and election secure, because \add if you\add*\ef + \fr 1:10 \ft ﻿*Here “if” is supplied as a component of the participle (“do”) which is understood as conditional \ef* do these \add things\add*, you will never ever stumble. 
...
\v 14 \add because I\add*\ef + \fr 1:14 \ft ﻿*Here “because” is supplied as a component of the participle (“know”) which is understood as causal \ef* know that the removal of my habitation is imminent, as indeed our Lord Jesus Christ made clear to me. 
...
\m 
\v 16 For we did not make known to you the power and coming of our Lord Jesus Christ \add by\add*\ef + \fr 1:16 \ft ﻿*Here “by” is supplied as a component of the participle (“following”) which is understood as means \ef* following ingeniously concocted myths, but \add by\add*\ef + \fr 1:16 \ft ﻿*Here “by” is supplied as a component of the participle (“being”) which is understood as means \ef* being eyewitnesses of that one’s majesty. 
\v 17 For \add he\add* received honor and glory from God the Father \add when\add*\ef + \fr 1:17 \ft ﻿*Here “when” is supplied as a component of the temporal genitive absolute participle (“was brought”) \ef* a voice such as this was brought to him by the Majestic Glory, “This is my beloved Son, in whom I am well pleased.” 
\v 18 And \add we\add* ourselves heard this voice brought from heaven \add when we\add*\ef + \fr 1:18 \ft ﻿*Here “when” is supplied as a component of the participle (“were”) which is understood as temporal \ef* were with him on the holy mountain, 
\v 19 and we possess \add as\add* more reliable the prophetic word, to which you do well \add if you\add*\ef + \fr 1:19 \ft ﻿*Here “if” is supplied as a component of the participle (“pay attention to”) which is understood as conditional \ef* pay attention to \add it\add* as to a lamp shining in a dark place, until the day dawns and the morning star rises in your hearts, 
...
\v 5 and did not spare the ancient world, but preserved Noah, a proclaimer of righteousness, ⸤and seven others⸥\f + \fr 2:5 \ft Literally “eighth” \f* \add when he\add*\ef + \fr 2:5 \ft ﻿*Here “when” is supplied as a component of the participle (“brought”) which is understood as temporal \ef* brought a flood on the world of the ungodly, 
...
\v 8 (for that righteous man, \add as he\add*\ef + \fr 2:8 \ft ﻿*Here “as” is supplied as a component of the participle (“lived”) which is understood as temporal \ef* lived among them day after day, was tormenting \add his\add* righteous soul by the lawless deeds \add he was\add* seeing and hearing), 
...
\p Bold \add and\add* arrogant, they do not tremble in awe \add as they\add*\ef + \fr 2:10 \ft ﻿*Here “as” is supplied as a component of the participle (“blaspheme”) which is understood as temporal \ef* blaspheme majestic beings, 
...
\v 13 being harmed \add as the\add* wages of unrighteousness. Considering reveling in the daytime a pleasure, \add they are\add* stains and blemishes, carousing in their deceitful pleasures \add when they\add*\ef + \fr 2:13 \ft ﻿*Here “when” is supplied as a component of the participle (“feast together”) which is understood as temporal \ef* feast together with you, 
\v 14 having eyes full of \add desire for\add* an adulteress and unceasing from sin, enticing unstable persons, \add and\add*\ef + \fr 2:14 \ft ﻿*Here “and” is supplied in keeping with English style \ef* having hearts trained for greediness. Accursed children! 
...
\v 5 For \add when\add*\ef + \fr 3:5 \ft ﻿*Here “when” is supplied as a component of the participle (“maintain”) which is understood as temporal \ef* they maintain this, it escapes \add their\add* notice that the heavens existed long ago and the earth held together out of water and through water by the word of God, 
\v 6 by means of which things the world that existed at that time was destroyed \add by\add*\ef + \fr 3:6 \ft ﻿*Here “by” is supplied as a component of the participle (“being inundated”) which is understood as means \ef* being inundated with water. 
...
\v 9 The Lord is not delaying the promise, as some consider slowness, but is being patient toward you, \add because he\add*\ef + \fr 3:9 \ft ﻿*Here “because” is supplied as a component of the participle (“want”) which is understood as causal \ef* does not want any to perish, but all to come to repentance. 
\v 10 But the day of the Lord will come like a thief, in which the heavens will disappear with a rushing noise, and the celestial bodies will be destroyed \add by\add*\ef + \fr 3:10 \ft ﻿*Here “by” is supplied as a component of the participle (“being burned up”) which is understood as means \ef* being burned up, and the earth and the deeds \add done\add* on it will be disclosed. 
\v 11 \add Because\add*\ef + \fr 3:11 \ft ﻿*Here “because” is supplied as a component of the participle (“are being destroyed”) which is understood as causal \ef* all these things are being destroyed in this way, what sort of \add people\add* must you be in holy behavior and godliness, 
\v 12 \add while\add*\ef + \fr 3:12 \ft ﻿*Here “while” is supplied as a component of the participle (“waiting for”) which is understood as temporal \ef* waiting for and hastening the coming of the day of God, because of which the heavens will be destroyed \add by\add*\ef + \fr 3:12 \ft ﻿*Here “by” is supplied as a component of the participle (“being burned up”) which is understood as means \ef* being burned up and the celestial bodies will melt \add as they\add*\ef + \fr 3:12 \ft ﻿*Here “as” is supplied as a component of the participle (“are consumed by heat”) which is understood as temporal \ef* are consumed by heat! 
...
\m 
\v 14 Therefore, dear friends, \add because you\add*\ef + \fr 3:14 \ft ﻿*Here “because” is supplied as a component of the participle (“are waiting for”) which is understood as causal \ef* are waiting for these \add things\add*, make every effort to be found at peace, spotless and unblemished in him. 
...
print(usfm_with_paragraph_breaks)